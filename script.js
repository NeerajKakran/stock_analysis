...
const tableData = [
    {
        ...
        files: [
            "Nifty 50 Prediction 2025-04-02.csv",
            "Nifty Fin Services Prediction 2025-04-02.csv",
            "Nifty Infra Prediction 2025-04-02.csv",
        ],
    },
    { name: "Nifty IT", file: "Nifty IT Prediction 2025-04-02.csv" },
    { name: "Nifty Auto", file: "Nifty Auto Prediction 2025-04-02.csv" },
    { name: "Nifty FMCG", file: "Nifty FMCG Prediction 2025-04-02.csv" },
    { name: "Nifty Metal", file: "Nifty Metal Prediction 2025-04-02.csv" },
    { name: "Nifty Bank", file: "Nifty Bank Prediction 2025-04-02.csv" },
];

// Folder path for CSV files
const folderPath = './2025-04-02/';
...
function renderTableLayout() {
    ...
    header.textContent = "Predictions for 25-April-02";
