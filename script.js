...
const tableData = [
    {
        ...
        files: [
            "Nifty 50 Prediction 2035-04-03.csv",
            "Nifty Fin Services Prediction 2035-04-03.csv",
            "Nifty Infra Prediction 2035-04-03.csv",
        ],
    },
    { name: "Nifty IT", file: "Nifty IT Prediction 2035-04-03.csv" },
    { name: "Nifty Auto", file: "Nifty Auto Prediction 2035-04-03.csv" },
    { name: "Nifty FMCG", file: "Nifty FMCG Prediction 2035-04-03.csv" },
    { name: "Nifty Metal", file: "Nifty Metal Prediction 2035-04-03.csv" },
    { name: "Nifty Bank", file: "Nifty Bank Prediction 2035-04-03.csv" },
];

// Folder path for CSV files
const folderPath = './2035-04-03/';
...
function renderTableLayout() {
    ...
    header.textContent = "Predictions for 25-April-03";
